...
gnuplot -p -e 'set datafile separator ","; plot "output.csv" using 1:2 with lines, "" using 1:4 with lines, "" using 1:13 with lines'
gnuplot -p -e 'set datafile separator ","; plot "output.csv" using 1:10 with lines, "" using 1:11 with lines, "" using 1:12 with lines'
# gnuplot -p -e 'set datafile separator ","; plot "output.csv" using 1:15 with lines, "" using 1:16 with lines
